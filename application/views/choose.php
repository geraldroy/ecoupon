...
<div class="desc column">
  <h1>Choose a Tree!</h1>
  <p>And our partner NGOs will plan it!</p>
</div>
    ...
    <div class="ui cards stackable grid">
      ...
      <div class="eight wide column">
        <div class="ui link fluid card">
          <div class="image">
            <img src="<?php echo base_url();?>img/trees/banaba.jpg" alt="">
          </div>
          <div class="content">
            <a href="#" class="header">Banaba</a>
            <div class="meta">
      ...
      <div class="eight wide column">
        <div class="ui link fluid card">
          <div class="image">
            <img src="<?php echo base_url();?>img/trees/ilangilang.jpg" alt="">
          </div>
          <div class="content">
            <a href="#" class="header">Ilang-ilang</a>
            <div class="meta">
      ...
      <div class="eight wide column">
        <div class="ui link fluid card">
          <div class="image">
            <img src="<?php echo base_url();?>img/trees/molave.jpg" alt="">
          </div>
          <div class="content">
            <a href="#" class="header">Molave</a>
            <div class="meta">
      ...
      <div class="eight wide column">
        <div class="ui link fluid card">
          <div class="image">
            <img src="<?php echo base_url();?>img/trees/ipil.jpg" alt="">
          </div>
          <div class="content">
            <a href="#" class="header">Ipil</a>
            <div class="meta">
              <span class="date">Intsia bijuga</span>
            </div>
            <div class="description">
              Ecologicially, Ipil trees are suitable for conservation in eroded gullies and in buffer strips along creeks, and also in water purification.
            </div>
          <div class="extra content">
            <br>
            <i class="fa fa-leaf"></i>
